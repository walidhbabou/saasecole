...
export const LANDING_FEATURES = [
  {
    ...
    descEn: "Complete profiles, student IDs, and parent contacts. Import or export Excel files in one click.",
  },
  {
    icon: "CalendarCheck",
    ...
    descEn: "Daily roll calls, automatic parent alerts, and detailed monthly reports.",
  },
  {
    icon: "CreditCard",
    ...
    descEn: "Flexible payment plans, overdue tracking, and automatic receipts.",
  },
  {
    icon: "Globe",
    ...
    descEn: "A complete interface in English, French, and Arabic with native RTL support.",
  },
  {
    icon: "Shield",
    titleFr: "Multi-tenant sécurisé",
    titleAr: "نظام متعدد المستأجرين",
    titleEn: "Secure multi-tenant",
    ...
    descEn: "Complete data isolation between schools with privacy built in.",
  },
  {
    icon: "BarChart3",
    ...
    descEn: "Live KPIs for attendance, fee collection, and class performance.",
  },
] as const;
